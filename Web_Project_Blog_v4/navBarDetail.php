                    ...
                    if($titleLenght > 20){
                        ...
                        '<li>
                            <form action="detail.php" method="POST">
                                <div class="input">
                                    <input type="hidden" name="postId" class="form-control" value="'. $partOfTitle .'">
                                    <input type="submit" class="btn btn-dark readAllBtn" value="'. $sameCatPostId .'"/>
                                </div>
                            </form>
                        </li>';
                    }
                        ...
                        '<li> 
                            <form action="detail.php" method="POST">
                                <div class="input">
                                    <input type="hidden" name="postId" class="form-control" value="'. $title .'">
                                    <input type="submit" class="btn btn-dark readAllBtn" value="'. $sameCatPostId .'"/>
                                </div>
                            </form>
                        <li>';
            ...
            <?php
                ...
                foreach($sameCatPosts as $sameCatPost){
                    ...
                    if($titleLenght > 20){
                        $partOfTitle = substr($title, 0, 23);
                        $partOfTitle = $partOfTitle . "...";
                        echo '<li><a href="#">' . $partOfTitle . '</a></li>';
                    }
                    else{
