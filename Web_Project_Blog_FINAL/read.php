...
<html lang="en">
    ...
    <body>
        <div id="wrapper">
            ...
            <!-- Side Menu toevoegen -->
            <?php 
                // Variabelen die zullen gebruikt worden in
                // navBarRead.php en worden in dit ducument geinitialiseerd
                $popPosts = PostDb::get3PopularPostIDs();
                $categories = CategoryDb::getAll();
                $dates = PostDb::getAllDates();
                $months = array();

                include ("navBarRead.php");  
            ?>
            ...
            <div id="page-content-wrapper">
                ...
                <!-- Gefilterde posts afhenkelijk van de filter die je kiest in de navBar -->
                <div id="filterResult">

                <!-- Hier staat de default page content indien je naar de pagina gaat (een overzicht van alle Posts) -->
                    ...
                    <?php
                        ...
                        // Hier staat de gefilterde pagecontent volgend category (indien deze gebruikt werd)
                    ...
                    <?php
                     ...
                     // Hier staat de gefilterde pagecontent volgend datum (indien deze gebruikt werd)
        ...
        <!-- Script voor de client side validatie -->
