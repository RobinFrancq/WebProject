...
<html lang="en">
    ...
    <body>
                ...
                <div class="row center" id="thePost">
                    ...
                    <!-- Vorm van de post -->
                        <div class="card-group-detail">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <span class="badge badge-info"><?php echo $postCategory ?></span>
                                    <h4 class="card-title"><?php echo $postTitle ?></h4>
                                    <p class="card-text info">
                                        By <em><?php echo $postAutor ?></em> | <em><?php echo $postDate ?></em> | <em><?php echo $postAmountOfComments ?></em> comment(s)
                                    </p>
                                    <p>
                                        <?php echo $postText ?>
                                    </p>
                    ...
                    <div class="list-group comments">
                        ...
                        <!-- Knop naar de commentForm die via een Get de juiste postID meegeeft -->
        ...
        <!-- JQuery die meer functionaliteit bevat dan de slim versie van Bootstrap -->
        ...
        <!-- Scripts van Bootstrap (omvat jQuery slim versie)-->
