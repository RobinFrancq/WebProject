<?php
    ...
    // Hier wordt nagegaan of de session geset is
...
<body>
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container loginForm" >
                    ...
                    ?>
                    <!-- Start van de register form met een post naar writeCheck.php -->
                    <!-- Deze form wordt ook Cient side gevalideert via writeValidation.js-->
    ...
    <!-- Script voor de Client side check van de write form -->                                
